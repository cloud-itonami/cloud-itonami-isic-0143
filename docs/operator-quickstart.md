# Operator Quickstart — Camelid-Raising Operations Coordination

Shortest path from clone to a verified local dry-run for **ISIC 0143** (`cloud-itonami-isic-0143`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-0143.git
cd cloud-itonami-isic-0143
```
...
- Blueprint governor key: `camelid-facility-operations-governor`
- Likely source path: `camelops.governor.cljc`
