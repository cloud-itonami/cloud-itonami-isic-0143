(ns camelops.phase
  "Phase gate for the camelid-raising operations coordinator rollout
  (0->3 maturity). Mirrors `cattleops.phase` (cloud-itonami-isic-0141)
  ...
  Phase 1: supervised operation -- always-escalate ops
    (`camelops.governor/always-escalate-ops`) escalate even when clean;
  ...
  (:require [camelops.governor :as governor]))
